    ...
    */
	insertDialog : function(dialog,ref,position)
    {
        ...
        if(!container)
        {
            ...
            objInsertNode(container,$("wfw_ext_lock"),null,INSERTNODE_BEGIN);
        }
            ...
            onInit: function () {
                ...
                objSetEvent(frame_obj,"load",function(e,dlg)
                {
                    ...
                    if(empty(dlg.title)){
                        ...
                        if(title_node)
                            objSetInnerText($(dlg.id+"_header"),objGetInnerText(title_node));
                    }
                ...
                var resize = function(image){
                    ...
                    var timer = wfw.timer.CreateFrequencyTimer({
                        ...
                        user: {
                            ...
                            org_width : 0,
                            org_height : 0,
                            max_h : objGetH($("wfw_ext_lock"))-10,
                            max_w : objGetW($("wfw_ext_lock"))-10
                        },
                        onStart    : function(){
...
*/
                ...
                objSetEvent(image,"click",function(e,p){
                    ...
                    //objRemoveChildNode($("wfw_ext_lock"),null,REMOVENODE_ALL);
                    wfw.ext.document.unlockScreen();
                },null);
        
                //[click]
                objSetEvent($("wfw_ext_lock"),"click",function(e,p){
                    //wfw.event.UnSetCallback( "wfw_window", "resize", "lockImageResize" );
                    //objRemoveChildNode($("wfw_ext_lock"),null,REMOVENODE_ALL);
                    wfw.ext.document.unlockScreen();
                },null);
    ...
    */
	...
	openLoadingBox : function(options){
        if($("&wfw_ext_document_LoadingBox") != null)
            return;
        var dlg = $new(wfw.ext.document.DIALOG_BOX, object_merge({
	...
	closeLoadingBox : function(){
        var dialog = $("&wfw_ext_document_LoadingBox");
        if(dialog == null)
            return;
