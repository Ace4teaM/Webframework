...
/*
	...
	Arguments:
		...
		wfw_item_category    : Optionnel, catégorie(s) de champs
		[...]                : Champs à définirs
...
rcheck(
	...
	//optionnels  
	array('wfw_item_guid'=>'','wfw_item_template_id'=>'cInputName','wfw_item_category'=>'')
);
...
// Globales
//
$item_category= (isset($_REQUEST['wfw_item_category']) ? $_REQUEST['wfw_item_category'] : "");
...
$param = $catalog_doc->doc->createElement("category");
$param->nodeValue = $item_category;
$node->appendChild($param);
