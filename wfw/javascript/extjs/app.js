...
Ext.application({
    ...
    launch: function() {
        Y = YUI(wfw_yui_config(wfw_yui_base_path)).use('node', 'event', 'event-simulate', 'wfw-io','wfw-result','wfw-xml-template', 'wfw-user', 'loading-box', 'io', 'wfw-navigator', 'wfw-request', 'wfw-xml','datatype-xml', function (Y)
        {
