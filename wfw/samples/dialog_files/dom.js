...
/*
    ...
    Exemple:
        ...
        objSetEvent( $("myElement"), "mouseover", myEventCallBack );
*/
//Standard
...
var _w3c_HTMLElement_removeChildNode = function(ref,position)
{
    ...
    switch(position){
        ...
        case REMOVENODE_FIRST:
            var first = objGetChild(this,null);
            if(first!=null)
...
var _a_Node_removeChildNode = function(ref,position)
{
    ...
    switch(position){
        ...
        //
        case REMOVENODE_FIRST:
            var first = nodeGetChild(this,null);
            if(first!=null)
                this.removeChild(first);
            return true;
        //
...
var _b_HTMLDocument_getElements = function(name){
	var objs = new Array();
	var oList = this.layers;
	//recherche
	for(var i=0;i<oList.length;i++){
